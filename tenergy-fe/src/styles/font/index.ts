...
export const p2 = "text-lg font-normal";
export const p3 = "text-base font-normal";
export const p4 = "text-sm font-normal";

export const tag1 = "text-sm font-medium";
export const tag2 = "text-xs font-medium";
